...
class ProgramDetailsCubit extends Cubit<ProgramdetailsState> {
  ProgramDetailsCubit({required this.getProgramDetailsUsecase})
  ...
  List<Widget> screens() {
    ...
    List<Widget> screens = [
      ProgramDetailsTap(programEntity: programData),
      ProgramFeatureTab(programEntity: programData),
      PreviousReviewsTab(programEntity: programData),
      LecturerDataTab(programEntity: programData),
    ];
    return screens;
  }
  ...
  Future<void> getProgramDetails({required int programId}) async {
    ...
    final result = await getProgramDetailsUsecase.call(
      parameter: ProgramDetailsParameters(programId: programId),
    );
