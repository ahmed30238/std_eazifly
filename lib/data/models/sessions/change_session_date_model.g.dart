...
ChangeSessionDateDataModel _$ChangeSessionDateDataModelFromJson(
  ...
  ..users = (json['users'] as List<dynamic>?)
      ?.map(
        (e) => ChangeSessionDateUserModel.fromJson(e as Map<String, dynamic>),
      )
      .toList()
  ...
  ..status = json['status'] == null
      ? null
      : ChangeSessionDateStatusModel.fromJson(
...
ChangeSessionDateStatusModel _$ChangeSessionDateStatusModelFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$ChangeSessionDateStatusModelToJson(
  ChangeSessionDateStatusModel instance,
) => <String, dynamic>{
