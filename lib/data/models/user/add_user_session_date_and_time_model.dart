...
AddUserSessionDateAndTimeModel addUserSessionDateAndTimeModelFromJson(
  String str,
) => AddUserSessionDateAndTimeModel.fromJson(json.decode(str));

String addUserSessionDateAndTimeModelToJson(
  AddUserSessionDateAndTimeModel data,
...
@JsonSerializable(explicitToJson: true)
class AddUserSessionDateAndTimeDatumModel
    extends AddUserSessionDateAndTimeDatumEntity {
  AddUserSessionDateAndTimeDatumModel();

  factory AddUserSessionDateAndTimeDatumModel.fromJson(
    Map<String, dynamic> json,
  ) => _$AddUserSessionDateAndTimeDatumModelFromJson(json);

  Map<String, dynamic> toJson() =>
      _$AddUserSessionDateAndTimeDatumModelToJson(this);
}
