...
UpgradeOrderDataModel _$UpgradeOrderDataModelFromJson(
  ...
  ..status = json['status'] == null
      ? null
      : UpgradeOrderStatusModel.fromJson(json['status'] as Map<String, dynamic>)
  ..type = json['type'] == null
      ? null
      : UpgradeOrderStatusModel.fromJson(json['type'] as Map<String, dynamic>)
  ...
  ..orderDetails = (json['order_details'] as List<dynamic>?)
      ?.map((e) => UpgradeOrderDetailModel.fromJson(e as Map<String, dynamic>))
      .toList();
