...
class RenewSubscriptionDataEntity {
  ...
  @JsonKey(name: "user")
  RenewSubscriptionUserModel? user;
  ...
  @JsonKey(name: "status")
  RenewSubscriptionStatusModel? status;

  @JsonKey(name: "type")
  RenewSubscriptionStatusModel? type;
  ...
  List<RenewSubscriptionOrderDetailModel>? orderDetails;

  RenewSubscriptionDataEntity({
    this.id,
    this.user,
...
class RenewSubscriptionOrderDetailEntity {
  @JsonKey(name: "id")
  int? id;
  ...
  RenewSubscriptionOrderDetailEntity({
    this.id,
    this.title,
    this.program,
    this.label,
...
class RenewSubscriptionStatusEntity {
  @JsonKey(name: "label")
  String? label;
