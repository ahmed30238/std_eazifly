...
class RemoveAssignedStudentUsecase extends BaseUsecase<
    RemoveAssignedStudentEntity, RemoveAssignedStudetParameters> {
  ...
  Future<Either<Failure, RemoveAssignedStudentEntity>> call(
      {required RemoveAssignedStudetParameters parameter}) async {
    return await baseRepository.removeAssignedStudent(
        userId: parameter.userId, programId: parameter.programId);
  }
}
