...
class CompleteChapterLessonUsecase extends BaseUsecase<
    CompleteChapterLessonEntity, CompleteChapterLessonParameters> {
  ...
  Future<Either<Failure, CompleteChapterLessonEntity>> call(
      {required CompleteChapterLessonParameters parameter}) async {
