...
class GetProgramAssignmentsUsecase extends BaseUsecase<
    GetProgramAssignmentsEntity, GetProgramAssignmentsParameters> {
  ...
  Future<Either<Failure, GetProgramAssignmentsEntity>> call(
      {required GetProgramAssignmentsParameters parameter}) async {
    return await baseRepository.getProgramAssignments(
        programId: parameter.programId, userId: parameter.userId);
  }
}
