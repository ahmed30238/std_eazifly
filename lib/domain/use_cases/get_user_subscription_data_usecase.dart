...
class GetUserSubscriptionDataUsecase extends BaseUsecase<
    GetUserSubscriptionDataEntity, GetUserSubscriptionDataParameters> {
  ...
  Future<Either<Failure, GetUserSubscriptionDataEntity>> call(
      {required GetUserSubscriptionDataParameters parameter}) async {
