...
class GetProgramPaymentMethodsUsecase extends BaseUsecase<
    GetProgramPaymentMethodsEntity, GetProgramPaymentMethodsParameters> {
  ...
  Future<Either<Failure, GetProgramPaymentMethodsEntity>> call(
      {required GetProgramPaymentMethodsParameters parameter}) async {
